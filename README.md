...
Ретеншн (retention) — это метрика, показывающая, какая доля пользователей возвращается к продукту через определенный период времени после первой покупки/регистрации.

**Основные типы ретеншна:**
...
### 4. Что бы я сделала для развития ретеншна?
...
- `retention_analysis.png` — графики и визуализации
- `business_insights.md` — детальные бизнес-инсайты
